...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        topMainCategoriesList.add(new TopMainCategories(R.drawable.ic_baseline_camera_24,"TOP Cateory"));
        topMainCategoriesList.add(new TopMainCategories(R.drawable.ic_baseline_camera_24,"TOP Cateory"));
        topMainCategoriesList.add(new TopMainCategories(R.drawable.ic_baseline_camera_24,"TOP Cateory"));
        setTopMainCategories(topMainCategoriesList);
        List<BodyProductNotSliding> bodyProductNotSlidingList = new ArrayList<>();
        bodyProductNotSlidingList.add(new BodyProductNotSliding("Test","3 KM",R.drawable.product1,"30$","20%","23%"));
        bodyProductNotSlidingList.add(new BodyProductNotSliding("Test","3 KM",R.drawable.product1,"30$","20%","23%"));
        bodyProductNotSlidingList.add(new BodyProductNotSliding("Test","3 KM",R.drawable.product1,"30$","20%","23%"));
        bodyProductNotSlidingList.add(new BodyProductNotSliding("Test","3 KM",R.drawable.product1,"30$","20%","23%"));
        bodyProductNotSlidingList.add(new BodyProductNotSliding("Test","3 KM",R.drawable.product1,"30$","20%","23%"));
        ...
        topStoresList.add(new TopStores(R.drawable.ic_baseline_person_24,"@_ahmed"));
        topStoresList.add(new TopStores(R.drawable.ic_baseline_person_24,"@a7medelnoor"));
        topStoresList.add(new TopStores(R.drawable.ic_baseline_person_24,"@ezeness"));
        topStoresList.add(new TopStores(R.drawable.ic_baseline_person_24,"@androidDeveloper"));
        ...
        bodyProductNotSlidingListSub.add(new BodyProductNotSliding("Test Sub","3 KM",R.drawable.product3,"30$","20%","23%"));
        bodyProductNotSlidingListSub.add(new BodyProductNotSliding("Test Sub","3 KM",R.drawable.product2,"30$","20%","23%"));
        bodyProductNotSlidingListSub.add(new BodyProductNotSliding("Test Sub","3 KM",R.drawable.product1,"30$","20%","23%"));
        bodyProductNotSlidingListSub.add(new BodyProductNotSliding("Test Sub","3 KM",R.drawable.product3,"30$","20%","23%"));
        bodyProductNotSlidingListSub.add(new BodyProductNotSliding("Test Sub","3 KM",R.drawable.product2,"30$","20%","23%"));
        bodyProductNotSlidingListSub.add(new BodyProductNotSliding("Test Sub","3 KM",R.drawable.product1,"30$","20%","23%"));
